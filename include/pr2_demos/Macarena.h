...
Task createDanceTask()
{
  ...
  task.push_back(createAction({{ 0., 0.98625, 0., -1.92394, 0., -2.17469, 0. },
                               ...
                               {{ -1.373, -0.189, 0.16787, -1.191, -0.30564, -0.446, -2.0821 },
                               { -1.373, -0.14833, 0.113, -1.321, 0.54236, -0.098, -1.45969 },
                               { -1.373, -0.189, 0.16787, -1.191, -0.30564, -0.446, -2.0821 },
                               { -1.373, -0.14833, 0.113, -1.321, 0.54236, -0.098, -1.45969 },
                               { -1.373, -0.189, 0.16787, -1.191, -0.30564, -0.446, -2.0821 },
                               { -1.373, -0.14833, 0.113, -1.321, 0.54236, -0.098, -1.45969 }}));
  ...
  task.push_back(createAction({{ 0.59245, 0.06705, 0.29680, -1.943, -1.3043, -0.28357, -0.75871  },
                               ...
                               { 0, -0.105499, -1.36273, -1.55524, -1.5109, -0.219097, 0. },
                               { -1.04851, -0.472102, -0.184554, -1.62857, 0.125212, -0.756032, 0. },
                               { -1.04851, -0.472102, -0.184554, -1.62857, 0.125212, -0.756032, 0. },
                               { 0., 0., 0., -1.52, 0, -1.52, 0. }}, 1.5));
